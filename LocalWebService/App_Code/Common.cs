...
public static class Common
{
    ...
    public static void WriteLog(string Page, string LogText,string MerchantID)
    {
        using (SqlConnection conn = new SqlConnection())
        {
            string Query = "s_ErrorLog_Insert";
    ...
    public static void SaveReqResponseData(string RefID, string MethodCalled, DateTime CallDate, string ReqData, string ResponseData, string ResponseCode, string ResponseText)
    {
        bool Done = false;
        try
        {
            using (SqlConnection conn = new SqlConnection())
            {
                string Query = "s_CheckoutServiceLog_Insert";//***
        ...
        {
            WriteLog("s_CheckoutServiceLog_Insert", ex.Message);
        }
    }
    public static bool SaveReqResponseData(string RefID, string MethodCalled, DateTime CallDate, string ReqData, string ResponseData, string ResponseCode, string ResponseText,string MerchantID,string EmpID)
    {
        bool Done = false;
        try
        {
            using (SqlConnection conn = new SqlConnection())
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    cmd.Parameters.Add("@MerchantID", System.Data.SqlDbType.VarChar).Value = MerchantID;
                    cmd.Parameters.Add("@IP", System.Data.SqlDbType.VarChar).Value = getIPAddress();
