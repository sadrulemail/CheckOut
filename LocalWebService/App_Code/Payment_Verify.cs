...
public class Payment_Verify
{
    ...
    public void ServiceReqResponseLog(string MerchantID, string RefID, string RequestData, string ResponseData, string Status)
    {
        ...
        try
        {
            ...
            {
                string Query = "s_ServiceReqResponseLog";
                ...
                using (System.Data.SqlClient.SqlCommand cmd = new SqlCommand())
                {
                    ...
                    cmd.Parameters.Add("@Request", System.Data.SqlDbType.VarChar).Value = RequestData;
                    cmd.Parameters.Add("@Response", System.Data.SqlDbType.VarChar).Value = ResponseData;
        ...
        catch (Exception ex)
        {
            ...
            Common.WriteLog("s_ServiceReqResponseLog", string.Format("{0}", ex.Message));
        }
    }
