<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true"
    CodeFile="Passport.aspx.cs" Inherits="Passport" Culture="en-nz" %>
                            ...
                            <div class="Panel1">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtUsedDateFrom" CssClass="Date" runat="server" Width="85px" AutoPostBack="true"
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtUsedDateTo" CssClass="Date" runat="server" Width="85px" AutoPostBack="true"
