        ...
        protected void cmd_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection())
            {
                ...
                using (SqlCommand cmd = new SqlCommand(Query, conn))
                {
                    ...
                    SqlParameter SQL_UserID = new SqlParameter("@ID", SqlDbType.Int);
                    SQL_UserID.Direction = ParameterDirection.InputOutput;
                    SQL_UserID.Value = UserId;
                    cmd.Parameters.Add(SQL_UserID);
                    ...
                    UserId = Int16.Parse(SQL_UserID.Value.ToString());
