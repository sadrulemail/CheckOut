<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Checkout_Payment.aspx.cs"
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder2" runat="server" ID="content3">
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 ">
                    <div>
                        ...
                        Welcome to Trust Bank Checkout. To pay please click on your desired payment method.
                    </div>
                    ...
                    <div class="panel panel-success" style="margin-top: 20px">
                                            ...
                                            <tr>
                                                <th colspan="2" class="text-center bold">
                                                    ...
                                                    <asp:ConfirmButtonExtender ID="ConfirmButtonExtenderTbmm" runat="server" TargetControlID="lnkTbmm"
                                                        ConfirmText="Do you want to pay using t-cash?">
                        ...
                        <hr style="margin: 0" />
                        <asp:Panel ID="PanelVM" runat="server">
                            ...
                            <div class="row" style="margin-top: 10px;">
                                <div class="col-sm-6 col-md-5 col-md-offset-1">
                                    <table class="table table-condensed">
                                        <thead>
                                            <tr>
                                                <th colspan="2" class="text-center bold">
                                                    <asp:LinkButton ID="lnkVM" runat="server" ForeColor="Green" Font-Size="110%" CommandArgument="VM"
                                                        OnCommand="lnk_Command">
                                                    VISA/Master Card
                                                    </asp:LinkButton>
                                                    <asp:ConfirmButtonExtender ID="ConfirmButtonExtenderVM" runat="server" TargetControlID="lnkVM"
                                                        ConfirmText="Do you want to pay using VISA/Master Card?">
                                                    </asp:ConfirmButtonExtender>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <asp:Label ID="lblVM_PaymentAmount" runat="server" Text="0.00"></asp:Label>
                                                Tk
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <asp:Label ID="lblVM_Charge" runat="server" Text="0.00"></asp:Label>
                                                Tk
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-right bold">
                                                <asp:Label ID="lblVM_Total" runat="server" Text="0.00"></asp:Label>
                                                Tk
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <div class="col-sm-6 col-md-5 text-center">
                                    <asp:LinkButton runat="server" ID="lnkVisaMaster" CommandArgument="VM" OnCommand="lnk_Command">
                                        <div class="bigbutton" title="Click to Pay">
                                            <img src="Images/vm.png" width="200" height="70" border="0" alt="" />
                                            
                                        </div>
                                        Click to Pay
                                    </asp:LinkButton>
                                    <asp:ConfirmButtonExtender ID="conlnkVM" runat="server" TargetControlID="lnkVisaMaster"
                                        ConfirmText="Do you want to pay using VISA/Master Card?">
                                    </asp:ConfirmButtonExtender>
                                </div>
                            </div>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="lnkVM" />
            <asp:PostBackTrigger ControlID="lnkVisaMaster" />
        </Triggers>
    </asp:UpdatePanel>
