...
public partial class VM_Cancelled : System.Web.UI.Page
{
    string xmlstr = "";
    string xmlmsg = "";
    string Amount = "0";
    ...
    {
        this.Title = string.Format("{0}", "Transaction Cancelled");
        ...
        try
        {
            ...
            using (SqlConnection conn = new SqlConnection())
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    //foreach (XmlNode node in x) // for each <testcase> node
                    {
                        try
                        {
                        ...
                        try
                        {
                            OrderStatus = x.SelectSingleNode("/Response/Tran_Status").InnerText;
                        ...
                        try
                        {
                            ResponseDescription = x.SelectSingleNode("/Response/RRN").InnerText;
            ...
            using (SqlConnection conn = new SqlConnection())
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    cmd.Parameters.Add("@RefID", System.Data.SqlDbType.VarChar).Value = order_id;
        ...
        catch (Exception ex) { Label1.Text += "<br>Error: " + ex.Message; }
