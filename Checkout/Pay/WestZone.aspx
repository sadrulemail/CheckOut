<%@ Page Title="" Language="C#" MasterPageFile="MasterPay.master" AutoEventWireup="true" CodeFile="WestZone.aspx.cs" Inherits="WestZone" %>
    ...
    <div class="row">
        <div class="col-sm-2">
            <a href="http://www.wzpdcl.org.bd/" target="_blank">
                <img src="../Images/Marchent/Wzpdcl.png" width="120" height="107"  alt="WZPDCL" />
            </a>
        </div>

        <div class="col-sm-8">
            West Zone Power Distribution Company Limited (WZPDCL) Payment
        </div>
            ...
            <div>
                ...
                <div class="form-inline">
                    <div class="row" style="margin-top: 5px;">
                        ...
                        <label class="col-sm-4 control-label">
                            WZPDCL Account Number
                        </label>
                        <div class="col-sm-4 col-md-3 has-feedback">
                            <asp:TextBox ID="txtAccount" runat="server" CssClass="form-control" MaxLength="18" placeholder="xxxxxxxx"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatortxtCustomer" runat="server" ValidationGroup="grpDueAmnt"
                                ControlToValidate="txtAccount" ErrorMessage="*" Style="margin: 5px" ForeColor="Red"
                ...
                <div class="row" style="margin-top: 5px;">
                    ...
                    <div class="col-sm-4 col-md-3 has-feedback col-md-offset-4 col-sm-offset-4">
                        ...
                        <asp:HiddenField ID="hidPaymentSuccessUrl" runat="server" />
                        <asp:HiddenField ID="hidOrderID" runat="server" />
                         <asp:HiddenField ID="hidOtc" runat="server" />
                    </div>
                   <%-- <div class="col-sm-4 col-md-3 has-feedback">
